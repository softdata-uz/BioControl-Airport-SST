...
import './category.css';
import CategoryAdd from "./addModal/CategoryAdd";
...
const Category = () => {
    ...
    const getCategoryData = async (id) => {
        const response = await axios.get(`${ip}/access-control-service/api/position/${categoryPaginationLimit}/${id}`,
            {
    ...
    const handleDeleteCategory = () => {
        axios.delete(`${ip}/access-control-service/api/delete/position`,
            {
                data: deletecategory,
                headers: {'x-access-token': localStorage.getItem('soft-ais-token')}
            })
            ...
            <div className="category_header">
                <div className="category_header_title">
                    <p className={`Content_title ${isDarkMode && 'darkModeColor'}`}>
                        {t("Tashkilot tuzilmasi / Lavozimlar")}
                    </p>
                </div>
            </div>
