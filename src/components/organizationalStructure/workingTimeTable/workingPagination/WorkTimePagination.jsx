...
const WorkTimePagination = (props) => {

    const {
        categoryPaginationLimit,
        categoryPaginationCurrent,
        categoryPaginationOnChange,
        categoryTotal,
    ...
    return <PaginationStyles
        ...
        defaultPageSize = {categoryPaginationLimit}
        current={categoryPaginationCurrent}
        onChange={categoryPaginationOnChange}
        total = {categoryTotal}
        showSizeChanger={true}
        pageSize={categoryPaginationLimit}
        pageSizeOptions={[10, 20, 30]}
        locale={{ items_per_page: t('sahifa') }}
    />;
}

export default WorkTimePagination;