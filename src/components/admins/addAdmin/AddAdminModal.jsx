    ...
    >
            ...
            >
                <div className="user_list_modal">
                    ...
                    <div className="user_list_modal_form_">
                            ...
                            <div className="user_list_modal_form_input">
                                ...
                                <Form.Item name="role" rules={[{
                                    ...
                                    >
                                        ...
                                        <Select.Option value="admin">Super Foydalanuvchi</Select.Option>
                                        <Select.Option value="operator">Foydalanuvchi</Select.Option>
                                        <Select.Option value="observer">Kuzatuvchi</Select.Option>
