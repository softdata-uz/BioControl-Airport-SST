...
const AdminPagination = (props) => {
    ...
    return <PaginationStyles
        ...
        defaultPageSize = {adminPaginationLimit}
        current={adminPaginationCurrent}
        onChange={adminPaginationOnChange}
        total = {adminTotal}
        showSizeChanger={true}
        pageSize={adminPaginationLimit}
