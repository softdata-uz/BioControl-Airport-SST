...
const AdminTable = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render:(text, record)=>(
                <div>
                    {record?.role ? (record.role=="superadmin" ? "Super Admin" : record.role=="admin" ? "Super Foydalanuvchi" : record.role=="operator" ? "Foydalanuvchi" :
                        record.role =="observer" ? "Kuzatuvchi" : "") : "..."}
                </div>
            )
        },
        {
