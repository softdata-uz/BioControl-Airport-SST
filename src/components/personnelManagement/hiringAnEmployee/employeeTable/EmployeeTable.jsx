...
const PrTable = (props) => {
    ...
    const deleteEmployee = (value , record) =>{
        setDeleteEmployee(prev => [...prev, value.id]);
        ...
        },
        {
            ...
            render:(text, record )=>(
                <div className="table_file_download">
                    <a className="link_style" href={`${ip}/access-control-service/api/file/hire_staff/${record.filename}`}><img src={word} alt=""/>Yuklash</a>
                </div>
            )
        },
        {
