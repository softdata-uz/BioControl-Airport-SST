...
const MaterialsTable = ({setChangePositionInitialValue, changePositionInitialValue}) => {
    ...
    const addRow = () => {
        ...
        setChangePositionInitialValue((initialValues) => ({
            ...initialValues,
    ...
    const deleteRow = (index) => {
        const updatedRows = [...changePositionInitialValue.relatives];
        // console.log(updatedRows)
        updatedRows.splice(index, 1);
        // setRows(updatedRows);
        setChangePositionInitialValue({...changePositionInitialValue, relatives: updatedRows});
    ...
    return (<div className="add_relatives_table">
        ...
        >
            <table>
                ...
                <tbody>
                {changePositionInitialValue.relatives.map((row, index) => (
